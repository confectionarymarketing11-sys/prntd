...
description:
"Compare DTF vs DTG printing for custom apparel. Learn about durability,
print quality, fabric compatibility, cost, and which printing method is best for
your project.",
};
...
<div className="absolute left-[-10%] top-[-10%] h-[520px] w-[520px]
rounded-full bg-[#4f46e5]/15 blur-[140px]" />
<div className="absolute bottom-[-10%] right-[-10%] h-[520px] w-[520px]
rounded-full bg-[#2563eb]/15 blur-[140px]" />
</div>
<div className="relative z-10">
<ShopHeader />
<section className="border-b border-white/10 pt-16">
<div className="mx-auto max-w-6xl px-6 py-24">
<div className="inline-flex rounded-full border border-white/10 bgwhite/[0.05] px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-
[#c7d2fe]">
Apparel Printing Guide
</div>
<h1 className="mt-8 text-[clamp(48px,8vw,92px)] font-black leading-
[0.95] tracking-[-0.06em]">
DTF vs
<span className="block bg-[lineargradient(135deg,#60a5fa_0%,#818cf8_45%,#a855f7_100%)] bg-clip-text texttransparent">
DTG Printing
</span>
</h1>
...
className="rounded-2xl bg-[lineargradient(135deg,#3b82f6,#6366f1,#8b5cf6)] px-8 py-4 font-black text-white
...
<section className="rounded-[32px] border border-cyan-500/20 bgcyan-500/10 p-8">
...
<section className="rounded-[32px] border border-white/10 bg-
[#0f172a]/80 p-8">
<h2 className="text-3xl font-black">
...
<section className="rounded-[32px] border border-green-500/20 bggreen-500/10 p-8">
<h2 className="text-3xl font-black">
...
<section className="rounded-[32px] border border-violet-500/20 bgviolet-500/10 p-8">
<h2 className="text-3xl font-black">
...
<section className="rounded-[32px] border border-amber-500/20 bgamber-500/10 p-8">
<h2 className="text-3xl font-black">
...
<section className="rounded-[32px] border border-red-500/20 bgred-500/10 p-8">
...
<section className="rounded-[36px] border border-[#6366f1]/20 bg-
[linear-gradient(135deg,rgba(99,102,241,.12),rgba(59,130,246,.12))] p-10 textcenter">
<h2 className="text-5xl font-black tracking-tight">
Final Verdict
</h2>
<p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-
[#cbd5e1]">
...
<Link
href="/designer?product=classic-tee"
className="mt-8 inline-flex rounded-2xl bg-[lineargradient(135deg,#3b82f6,#6366f1,#8b5cf6)] px-8 py-4 font-black text-white
shadow-[0_12px_40px_rgba(99,102,241,0.35)]"
>
